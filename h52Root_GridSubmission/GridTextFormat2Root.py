...
def main():
    ...
    tf = TFile( storage+'run_'+iter+'/raw_e320_a0_'+str(xiInput)+'_gamma'+str(gammaInput)+'_v'+ver+'.root', 'recreate' )
    print("The output file: ", storage+'run_'+iter+'/raw_e320_a0_'+str(xiInput)+'_gamma'+str(gammaInput)+'_v'+ver+'.root')
